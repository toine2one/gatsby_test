  ...
  return (
    ...
    >
      <div
        ...
        className="carousel slide carousel-fade h-80 d-none d-lg-block"
        data-bs-ride="carousel"
        data-bs-interval="false"
      >
        <div className="carousel-inner h-80">
          <div className="carousel-item active d-flex  justify-content-center h-100 w-100">
      ...
      <div
        ...
        className="carousel slide carousel-fade d-block d-lg-none"
        data-bs-ride="carousel"
        data-bs-interval="false"
      >
